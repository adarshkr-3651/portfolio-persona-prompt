...
const Portfolio = () => {
  const projects = [
    {
      title: "Sukni",
      description: "Developed automation pipelines using n8n for content scheduling. Integrated AI to generate captions and hashtags dynamically.",
      image: "placeholder",
    ...
    {
      title: "Ebilos",
      description: "Built a full-stack book marketplace using Next.js, Appwrite, and MongoDB. Integrated bidding logic to mimic real market behavior, deployed on Netlify and managed state with React Hooks.",
      image: "placeholder",
      technologies: ["Next.js", "Appwrite", "MongoDB", "Netlify", "React"],
      liveUrl: "#",
      githubUrl: "#",
    },
    {
      title: "Zombied",
      description: "Built in Unity using C# scripting and environment animation. Designed user input systems, AI enemy movement, and game mechanics.",
      image: "placeholder",
      technologies: ["Unity", "C#", "Animation", "AI"],
      liveUrl: "#",
      githubUrl: "#",
    },
    {
